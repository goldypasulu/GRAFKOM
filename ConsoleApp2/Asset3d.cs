...
namespace ConsoleApp2
{
    class Asset3d
    {
        ...
        public void load(int sizeX, int sizeY)
        {
            ...
            view = Matrix4.CreateTranslation(0, 0, -8.0f); //camera
            projection = Matrix4.CreatePerspectiveFieldOfView(MathHelper.DegreesToRadians(45.0f), sizeX / (float)sizeY, 0.01f, 100f); //settingan camera
